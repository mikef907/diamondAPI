    ...
    public class PlayerController : Controller
    {
        ...
        public IEnumerable<DM.PlayerMatch> GetPlayerMatches() {
            ...
            var matches = _uow.Repo<Match>()
                .Where(p => p.PlayerMatches, p => !p.Finished && p.PlayerMatches.Any(pm => pm.PlayerId == userId));
            ...
            return _mapper.Map<IEnumerable<DM.PlayerMatch>>(pMatches);
        }
        ...
        public IEnumerable<DM.GameMove> GetMatchMoves(Guid matchId) =>
            _mapper.Map<IEnumerable<DM.GameMove>>(
                _uow.Repo<GameMove>().Where(gm => gm.GameState,
